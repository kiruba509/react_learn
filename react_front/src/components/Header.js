...
const products = [
  { name: 'Analytics', description: 'Get a better understanding of your traffic', href: '/products/analytics', icon: ChartPieIcon },
  { name: 'Engagement', description: 'Speak directly to your customers', href: '/products/engagement', icon: CursorArrowRaysIcon },
  { name: 'Security', description: 'Your customers’ data will be safe and secure', href: '/products/security', icon: FingerPrintIcon },
  { name: 'Integrations', description: 'Connect with third-party tools', href: '/products/integrations', icon: SquaresPlusIcon },
  { name: 'Automations', description: 'Build strategic funnels that will convert', href: '/products/automations', icon: ArrowPathIcon },
]
const callsToAction = [
